                ...
                @foreach($items as $member)
                    <div class="assembly-card">
                        ...
                        <div class="avatar-wrapper">
                            ...
                            @if($imageSrc)
                                <img loading="lazy" decoding="async" src="{{ $imageSrc }}" class="avatar-img" alt="{{ $member->name }}" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
