                        ...
                        @foreach($sliders as $slide)
                            <div class="swiper-slide position-relative">
                                @if(!empty($slide->image))
                                    <img decoding="async" fetchpriority="high" class="hero-slide-image" src="{{ \App\Support\Media\MediaUrl::forDiskPath('public', $slide->image) }}" alt="{{ $slide->title ?? $association->name }}">
                                @else
            ...
            @foreach($news->take(3) as $item)
                <div class="col-lg-4">
                    <article class="news-card-home">
                        @if(!empty($item->image))
                            <img loading="lazy" decoding="async" src="{{ \App\Support\Media\MediaUrl::forDiskPath('public', $item->image) }}" alt="{{ $item->title }}">
                        @else
            ...
            <div class="col-md-4 mb-3">
                <div class="card h-100 shadow-sm">
                    ...
                    @if($sliderMedia && !empty($sliderMedia->file))
                        <img loading="lazy" decoding="async" src="{{ \App\Support\Media\MediaUrl::forDiskPath('public', $sliderMedia->file) }}" class="card-img-top">
                    @endif
