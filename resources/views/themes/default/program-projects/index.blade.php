        ...
        @forelse($projects as $project)
            <div style="border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;background:#fff;">
                @if(!empty($project->cover_image))
                    <img loading="lazy" decoding="async" src="{{ \App\Support\Media\MediaUrl::forDiskPath('public', ltrim($project->cover_image, '/')) }}" alt="{{ $project->title }}" style="width:100%;height:220px;object-fit:cover;">
                @endif
