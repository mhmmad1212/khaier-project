...
class SiteSetting extends TenantModel
{
    protected $fillable = [
        ...
        'meeting_minutes_board_template_key',
        'meeting_minutes_general_template_key',
        'meeting_minutes_committee_template_key',
        'employees_template_key',
        'program_projects_index_template_key',
        'program_projects_show_template_key',
        'volunteer_opportunities_index_template_key',
        'volunteer_opportunities_show_template_key',
        'services_template_key',
        'bank_accounts_template_key',
        'beneficiary_services_template_key',
        'executive_director_template_key',
        'page_template_key',
