...
use App\Filament\Admin\Resources\ProgramProjectResource\RelationManagers\AttachmentsRelationManager;
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\RichEditor::make('description')
                ...
                ->helperText('يمكن إدراج صور المشروع من داخل المحرر، لذلك تم إخفاء حقل صور المشروع المستقل مؤقتًا.')
                ->columnSpanFull(),
            ...
            Forms\Components\Hidden::make('report_file')
                ->default(fn () => request('selected_media_file')),
